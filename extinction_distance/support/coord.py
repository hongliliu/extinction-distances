...
def match(ra1, dec1, ra2, dec2, tol, allmatches=False,seps=True):
    """
...
def unique_radec(ra, dec, tol):
    ...
    """
    imatch, inomatch = match(ra, dec, ra, dec, tol,
                             allmatches=True, indices=True)
